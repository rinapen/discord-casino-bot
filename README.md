...
シンプルで手軽な50%の確率ゲームです。コインを投げて、表か裏かを当てます。
...
2つのサイコロを振るクラップス風ゲームです。合計値によって勝敗が決まります。
...
他のプレイヤーと対戦する数字当てゲームです。3桁の数字を推測して当てます。

- **コマンド**: `?ヒットアンドブロー @ユーザー [金額]`
- **ルール**:
  - 相手プレイヤーに挑戦を申し込み
  - お互いが3桁の数字を設定（0〜9、重複なし）
  - 交互に数字を推測
  - 「ヒット」: 数字と位置が正しい
  - 「ブロー」: 数字は正しいが位置が違う
  - 先に相手の数字を当てた方が勝利
...
- **Issues**: バグ報告や機能リクエストは [GitHub Issues](https://github.com/rinapen/discord-casino-bot/issues)
